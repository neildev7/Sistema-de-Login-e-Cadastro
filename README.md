...
- Se o MySQL estiver indisponível, o servidor continua respondendo páginas públicas e as rotas que dependem do banco retornam HTTP `503` com uma mensagem clara.
